...
## [1.40.0](https://github.com/TylerStaplerAtFanatics/stapler-squad/compare/v1.39.0...v1.40.0) (2026-07-27)


### Features

* **backlog:** add BacklogItemEvent proto schema and WatchBacklogItems RPC ([fd80654](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/fd80654db228789043c59c14e2a1381939fce8ee))
* **backlog:** add backlogItemsSlice with normalized state and memoized selectors ([92fa823](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/92fa8232567ad26abc0fb589049e1efcddd9678d))
* **backlog:** add column-transition fade to Kanban board on live status changes ([bf04a6a](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/bf04a6a04caf375cf4f91b245924bebf5f9bc606))
* **backlog:** add flash-on-update visual treatment respecting prefers-reduced-motion ([fc370b9](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/fc370b9d50306a82cd00bb73e8f91dfa0c364ee5))
* **backlog:** add ItemChangePublisher interface and event-bus adapter ([57ceff6](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/57ceff66899a68466a93d1259069d895c27ad0d1))
* **backlog:** add useWatchBacklogItems hook with idle-staleness backstop ([d366c26](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/d366c268d9f1eae19f7878fec6d560ba3012c7ee))
* **backlog:** configurable WIP cap + queued status for backlog work items ([#199](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/199)) ([32405b1](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/32405b161e4c02bb6f2ad033315bb194945d8e6f))
* **backlog:** expose item ID + deep link, restore board detail pane ([#216](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/216)) ([b7bfb30](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/b7bfb308e5380ccad74a35b4120b76dfafbc7cf7))
* **backlog:** fade out list rows that leave the active filter live (Epic 6.3) ([6da72a0](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/6da72a00b9c7d41ff569674fd6afe5e9388a108f))
* **backlog:** implement WatchBacklogItems streaming RPC handler ([00c49a5](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/00c49a5acd014cd9f41ed3beb914f1c08ebe05a2))
* **backlog:** mount ConnectionIndicator across all backlog live views ([36dabca](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/36dabca490fa4fa5451b30577cc592a62fa93db5))
* **backlog:** PostToolUse git-drift steering hook for autonomous sessions ([1ac4bbd](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/1ac4bbd483d14923b812a0e5234590f8fd5c376c))
* **backlog:** progressive disclosure + session diagnostics for item detail panel ([#208](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/208)) ([8b37535](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/8b37535575b47675866f2dec98d6b2e9ae0e2286))
* **backlog:** publish BacklogItemEvent from remaining mutation methods ([9e39106](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/9e39106968ef4b0df7408fea0a8adf2186bff50e))
* **backlog:** publish BacklogItemEvent from TransitionBacklogItemStatus ([36286d6](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/36286d634bd2077aa38f5a0d9782741b3db9a188))
* **backlog:** report_pr_created MCP tool + orphaned-PR reconciliation backstop ([547eeda](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/547eeda578e7d4a4384082df074889dad8ee81d7))
* **backlog:** seed an sdd PipelineMode and an opt-in default-selection flag ([c2adbc7](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/c2adbc7a6274e1d864a12de7f38595a01b43fb9b))
* **backlog:** wire /backlog list to live WatchBacklogItems stream ([6ab62d0](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/6ab62d0f0fabb0268526fa942496e1571d131b09))
* **backlog:** wire /backlog/board to live WatchBacklogItems stream ([be7f46c](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/be7f46c9becd6f8c17d4f2e408f832d27b7858ce))
* **backlog:** wire BacklogItemDetail to live WatchBacklogItems stream ([241bdb6](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/241bdb6852179caf500ed2f2169e1e670c1364cf))
* **backlog:** wire BacklogItemPanel to live WatchBacklogItems stream ([31b774d](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/31b774daeeefb8b13e50c9f40e97140db80b0cea))
* **events:** add BacklogItemChanged event type and payload ([ef2f9f7](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/ef2f9f70b208bb501bb994504afb862cd9de94de))
* **git-history-cutover:** add 05-local-resync.sh for post-rewrite pull-down ([63581ed](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/63581ed36fee3edd36dae65b8cd458c3dfc29f89))
* **session-list:** add collapsible category headers ([#211](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/211)) ([bc31485](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/bc314858d63ec2d448559eebc278b289c4982522))
* **session:** add workspace peer awareness across sessions ([#215](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/215)) ([cce887b](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/cce887bb74420c2b80c3e1f84d039a9b7948b903))
* **shell:** stream shell tabs through the control-mode pipeline ([716bd91](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/716bd91271c194e556fade5e520ebac955c1dd67))
* **skills:** add git-history-cutover skill to drive the LFS purge runbook ([0a7026b](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/0a7026b166e076b13c21787358adff6a82067f3e))
* **unfinished:** rebrand to "Up Next" with backlog queue + GitHub issue import ([#212](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/212)) ([2d8560f](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/2d8560f033c6e80b9257cb3c8ddd30e344febb96))
* **web:** always stream log/warn/error to server, gate only console.debug behind toggle ([30010bf](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/30010bf207e128b8e85d2d7dca7a9eaae724c88e))
* **workflows:** add Simple/Advanced cron schedule widget ([#218](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/218)) ([23ea31e](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/23ea31ee1e53a6feed47d4e88309f4e0491bc05c))


### Bug Fixes

* **backlog:** add missing live-update flash to /backlog list rows ([ab13ec2](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/ab13ec247d851a10b26dadb306c8ab5b448517bc))
* **backlog:** add missing readOnly prop to GateVerdictBox, backfill required mock fields ([175e698](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/175e69882c08a6aaa6ea3400dabb270c881e3057))
* **backlog:** check for already-shipped work before reopening a closed PR ([365e98c](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/365e98cf32d6941b319a81cf8c52ab02593a4c71))
* **backlog:** check RemediationBlocked(bouncing) before renotifying no-verdict review exits ([1b1fb20](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/1b1fb209370326e3e55f73f488662ea50be54516))
* **backlog:** close remaining publish-hook bypasses on ItemSession mutations ([902a8de](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/902a8de853a80582b52a63213e69b5c1e0ecdef1))
* **backlog:** darken InlineNotice's accent text/icon color for WCAG AA contrast ([7013060](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/70130601ec57749170c8f7771c97f893352b2975))
* **backlog:** debounce reconnecting-&gt;live flicker, announce status changes ([3bbc99a](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/3bbc99af2958d1634a84802de503130b976f3c84))
* **backlog:** eager-load ItemSessions so live events don't blank verdict/triage data ([65c53b7](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/65c53b74fa18b88bde4373c67273fbe029229f24))
* **backlog:** give stuck review-role autonomous_stuck rows a remediation path (BUG-048) ([36249ac](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/36249ac1b5288490813a53dcd3e31d1b506f1db7))
* **backlog:** guard commit/push staging against already-tracked scaffolding files ([#206](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/206)) ([92c1c71](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/92c1c7113590b48bb2f51e5f4ee407eeda62c08f))
* **backlog:** harden TriggerReReview's diff/codebase-read path against a gone worktree ([fee6ad2](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/fee6ad2ee2851408d7666cc65170b510c3a18725))
* **backlog:** implement GitHub issue import + reachable Approve Plan action ([#220](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/220)) ([2f3fe9e](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/2f3fe9e46c98e4b1623f2a7d525e75e91e4d5345))
* **backlog:** make main-sync a precondition of review, not a PR-fix side effect ([4aca93c](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/4aca93cffa924c9ee154b518ccf2593acf711e9a))
* **backlog:** notify operator when reopen is blocked by a stale-but-alive work session ([86665d2](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/86665d26dcd01acb69fa9cb7a8c373d6d2c6ca17))
* **backlog:** nudge work sessions toward isolated manual testing ([6c8e788](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/6c8e788ffc1404c0bc57f1da3c935ec4eefbbc1f))
* **backlog:** pin edit-mode buffered-update banner outside scrollArea (Epic 6.4) ([cf37d10](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/cf37d10052984c3dbb9da45291d5dfbdc1691251))
* **backlog:** publish live event when ReconcileStuckItems transitions status ([959715d](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/959715dbac2aa082f13648166d775d07752d44c6))
* **backlog:** recalibrate stale-session thresholds + durable rework-block trace ([#219](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/219)) ([b2a12ea](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/b2a12eac2090109aacc808ec9b08d3714d182feb))
* **backlog:** record status-change audit events on all mutation paths ([#198](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/198)) ([5d6b41e](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/5d6b41eb860a7ff9f98c7c947709b645150a80c6))
* **backlog:** refuse codebase-read review fallback to shared main checkout (BUG-045) ([20eeaa8](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/20eeaa8a22442114ac8ce7873dda9c2821e8583d))
* **backlog:** render queued/pr_pending/refining items on the kanban board ([23d173e](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/23d173e3575515e1c2b62c2f96df9ae203cefba7))
* **backlog:** resolve any stuck reason on terminal status, not just autonomous_stuck/push_failed ([#204](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/204)) ([a758b3a](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/a758b3ae0d3b45ff21aca0c1b3111218490b8587))
* **backlog:** resolve orphaned push_failed rows on item completion ([#203](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/203)) ([a5053cc](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/a5053cc3de443ced34fb8eed26368f529617d2bd))
* **backlog:** restore status-change audit trail (events, triggeredBy, empty state) ([#214](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/214)) ([c20be97](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/c20be974f4eb64f152b8d0cf896fe43511c1958c))
* **backlog:** show gate verdict in BacklogItemPanel ([e71c06b](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/e71c06b44dfcb8182c91a39c43ab9331704fa6be))
* **backlog:** show last review verdict read-only after item leaves review status ([897d3de](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/897d3de803f903a01b8cc6ed9448c2b6bd5fb125))
* **backlog:** stop a fresh worktree's own base commit from reading as shipped ([31fb6d4](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/31fb6d4a74c4434b5e8a9a83aa7f41fc78e67de0))
* **backlog:** stop abandoned_review from burning its budget on respawns the bouncing gate will discard ([d9aa2b5](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/d9aa2b50cbe341e5e4086214161c0eb23610ace8))
* **backlog:** stop AutonomousDriver's orchestrator-inferred DONE from forcing premature review ([#222](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/222)) ([03e6414](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/03e64143d41d2f1e5638875a14d6e9c1791b2b44))
* **backlog:** stop flagging bouncing items whose PR already merged ([e310108](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/e31010815e376c6c28c5e59d0e97622f97911329))
* **backlog:** stop pr_pending items from losing their PR reference forever ([b235f86](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/b235f86aa02be83a7629f2baaf7995b5ca11e9fa))
* **backlog:** stop the stuck-review liveness checker from starving review-gate sessions ([b653b4f](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/b653b4fa5ba3abe05bfca1dd284e113ee69ca60c))
* **backlog:** stop trusting a stale base-commit SHA as proof of shipped work ([eda0e0e](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/eda0e0e1bcb90b3d0fb317f0c361d7f2a2cec080))
* **backlog:** stop unprocessed-review-verdict sweep from renotifying the same dead session every tick ([78f5bf7](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/78f5bf7be3e1da8ca9130d87db5c7bdc4a4344d7))
* **backlog:** stop wasted rework cycles from two review-reconciliation gaps ([3203fbe](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/3203fbe260683b714ba97ee5e0b0ee71f982b0d1))
* **backlog:** stop WatchBacklogItems hanging when nothing to report ([3df0d29](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/3df0d290673fece745f81c5e80d5194d8c0d4f38))
* **backlog:** surface queued items permanently blocked by the planning gate ([68f1c9a](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/68f1c9a7e874028b62af72314e94160ba5e59444))
* **backlog:** surface swallowed AutoReopenAfterFailedReview spawn+rollback failures ([3b7f3ba](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/3b7f3baef0b3f5683a365b191a74d20ab0b02d5a))
* **backlog:** unstick bouncing items whose code shipped without a PR ([fdf3522](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/fdf352203484952072e018afd06ea81266729e54))
* **backlog:** update remaining TransitionBacklogItemStatus call sites for merged 5-arg signature ([3b6efd6](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/3b6efd682d38736a023e3428ad1d95e7f0d3675c))
* **backlog:** wire pr_pending_no_pr remediation action ([df9f558](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/df9f5588e70144e8d9f0d0d30443cfb6fe8fdb8e))
* **gogitstore:** replace direct exec.Command with safeexec.CommandContext ([#223](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/223)) ([42808a2](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/42808a249e35cf6488615c5ea1cac57b9975ddd6))
* **headless:** surface swallowed ctx-timeout errors, revert bypassPermissions, add failure telemetry ([#221](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/221)) ([2403d8f](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/2403d8f4d20a78c87b0a5a1cecc8d3ee3bd5e985))
* **mcp:** resolve terminal tool mutations against the live instance, not a fresh deferred-start reload ([76c9076](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/76c9076fb8ec26f82d0819532ce90587de944235))
* **omnibar:** bound worktree/session-create requests to fix indefinite hangs ([#207](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/207)) ([3482017](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/3482017504c9404036ca96609d7d6503e88cb0a3))
* **server:** bind both loopback addresses on dual-stack hosts ([9d3b455](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/9d3b45528a2dbb2fc7f4d5566a9512fe64d6d4b6))
* **session:** avoid tmux command-too-long failure on large claude prompts ([219e4d9](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/219e4d96209f7eecf4d775a74b2b3a9dd03ceb45))
* **session:** keep external tmux streamers in sync with shell lifecycle ([187f9c4](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/187f9c40b75fb7a32280a5ffd4147431930df08f))
* **session:** notify backlog lifecycle listeners on operator-initiated session stop ([dd32916](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/dd32916175cea39c86e98169dfc9434ec324257e))
* **session:** rate-limit backlog nudge retry on SendKeys failure (BUG-041) ([b8763c6](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/b8763c63d1a2de3317a9d7c007d0d3786c2212f4))
* **session:** refuse to persist a worktree session's WorkingDir if it escaped the worktree ([e67f85e](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/e67f85efaac069840213bc3fd6e07d621bf7bb09))
* **session:** split autonomous-driver turn injection into separate paste+submit writes ([96a2d22](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/96a2d223684a75eb0c958dac337b6924dac941a9))
* **session:** use carriage return not newline to submit WriteToSession input ([4d2fab6](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/4d2fab668a527795eb9db4d3010d5ecbf14fca5e))
* **shell:** fall back to capture-pane polling after early control-mode exit ([d146b96](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/d146b96139a3d497ccc29e1a90b6ff5e607b4fb2))
* **terminal:** fix xterm theme flip and unpainted rows beyond 80x24 ([01cc299](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/01cc299a779480e79863336ca920a9148b181efb))
* **tmux:** kill orphaned control-mode clients left over from a prior process instance ([b6e76be](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/b6e76be7ddf8aba4cd51f6421309b160a4a8f1cf))
* **unfinished:** fix mobile sizing on Unfinished page and its modals ([#210](https://github.com/TylerStaplerAtFanatics/stapler-squad/issues/210)) ([aa976a7](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/aa976a7ac52f93d164d49580416f881843faae7a))
* **unfinished:** stop the scanner's watch list from growing forever ([8fd954d](https://github.com/TylerStaplerAtFanatics/stapler-squad/commit/8fd954de61f9167365335a8befb1f2777d3b49ce))
