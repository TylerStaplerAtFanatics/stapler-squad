...
type SessionUpdatedEvent struct {
	...
	DetectedStatus DetectedStatus `protobuf:"varint,3,opt,name=detected_status,json=detectedStatus,proto3,enum=session.v1.DetectedStatus" json:"detected_status,omitempty"`
	// Human-readable context string from the terminal pattern detector.
	// Empty when detected_status is UNSPECIFIED.
	DetectedContext string `protobuf:"bytes,4,opt,name=detected_context,json=detectedContext,proto3" json:"detected_context,omitempty"`
	unknownFields   protoimpl.UnknownFields
	sizeCache       protoimpl.SizeCache
}
...
func (x *SessionUpdatedEvent) GetDetectedStatus() DetectedStatus {
	if x != nil {
...
func (x *SessionUpdatedEvent) GetDetectedContext() string {
	if x != nil {
...
var file_session_v1_events_proto_goTypes = []any{
	...
	(*TerminalData)(nil),                      // 5: session.v1.TerminalData
	(*ShellStatusUpdate)(nil),                 // 6: session.v1.ShellStatusUpdate
