...
func (i *Instance) ToInstanceData() InstanceData {
	...
	data := InstanceData{
		...
		GitHubPRNumber:  snap.GitHubPRNumber,
		...
		// GitHub integration fields
		GitHubIsFork: snap.GitHubIsFork,
		...
		GitHubApprovedCount:    snap.GitHubApprovedCount,
		GitHubChangesReqCount:  snap.GitHubChangesReqCount,
		GitHubCheckConclusion:  snap.GitHubCheckConclusion,
		GitHubPRStatusTerminal: snap.GitHubPRStatusTerminal,
		LastPRStatusCheck:      snap.LastPRStatusCheck,
		// Crew autonomy mode
