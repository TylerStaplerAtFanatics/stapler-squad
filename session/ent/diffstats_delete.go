...
func (_d *DiffStatsDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(diffstats.Table, sqlgraph.NewFieldSpec(diffstats.FieldID, field.TypeInt))
...
func (_d *DiffStatsDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{diffstats.Label}
	default:
		return nil
	}
}
