...
func (_d *ClaudeSessionDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(claudesession.Table, sqlgraph.NewFieldSpec(claudesession.FieldID, field.TypeInt))
...
func (_d *ClaudeSessionDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{claudesession.Label}
	default:
		return nil
	}
}
