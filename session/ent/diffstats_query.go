...
func (_q *DiffStatsQuery) QuerySession() *SessionQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(diffstats.Table, diffstats.FieldID, selector),
...
// First returns the first DiffStats entity from the query.
// Returns a *NotFoundError when no DiffStats was found.
func (_q *DiffStatsQuery) First(ctx context.Context) (*DiffStats, error) {
	...
	if len(nodes) == 0 {
		return nil, &NotFoundError{diffstats.Label}
	}
	return nodes[0], nil
}
...
// FirstID returns the first DiffStats ID from the query.
// Returns a *NotFoundError when no DiffStats ID was found.
...
// Only returns a single DiffStats entity found by the query, ensuring it only returns one.
// Returns a *NotSingularError when more than one DiffStats entity is found.
// Returns a *NotFoundError when no DiffStats entities are found.
func (_q *DiffStatsQuery) Only(ctx context.Context) (*DiffStats, error) {
	...
	case 0:
		return nil, &NotFoundError{diffstats.Label}
	default:
		return nil, &NotSingularError{diffstats.Label}
	}
}
...
// OnlyID is like Only, but returns the only DiffStats ID in the query.
// Returns a *NotSingularError when more than one DiffStats ID is found.
...
func (_q *DiffStatsQuery) OnlyID(ctx context.Context) (id int, err error) {
	...
	case 0:
		err = &NotFoundError{diffstats.Label}
	default:
		err = &NotSingularError{diffstats.Label}
	}
	return
}
...
func (_q *DiffStatsQuery) All(ctx context.Context) ([]*DiffStats, error) {
	...
	qr := querierAll[[]*DiffStats, *DiffStatsQuery]()
	return withInterceptors[[]*DiffStats](ctx, _q, qr, _q.inters)
}
...
func (_q *DiffStatsQuery) IDs(ctx context.Context) (ids []int, err error) {
	...
	if err = _q.Select(diffstats.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (_q *DiffStatsQuery) Count(ctx context.Context) (int, error) {
	...
	return withInterceptors[int](ctx, _q, querierCount[*DiffStatsQuery](), _q.inters)
}
...
// Clone returns a duplicate of the DiffStatsQuery builder, including all associated steps. It can be
...
func (_q *DiffStatsQuery) Clone() *DiffStatsQuery {
	...
	return &DiffStatsQuery{
		config:      _q.config,
		ctx:         _q.ctx.Clone(),
		order:       append([]diffstats.OrderOption{}, _q.order...),
		inters:      append([]Interceptor{}, _q.inters...),
		predicates:  append([]predicate.DiffStats{}, _q.predicates...),
...
func (_q *DiffStatsQuery) GroupBy(field string, fields ...string) *DiffStatsGroupBy {
	...
	grbuild := &DiffStatsGroupBy{build: _q}
	grbuild.flds = &_q.ctx.Fields
	grbuild.label = diffstats.Label
...
func (_q *DiffStatsQuery) Select(fields ...string) *DiffStatsSelect {
	...
	sbuild := &DiffStatsSelect{DiffStatsQuery: _q}
	sbuild.label = diffstats.Label
...
func (_q *DiffStatsQuery) prepareQuery(ctx context.Context) error {
...
func (_q *DiffStatsQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*DiffStats, error) {
	var (
		nodes       = []*DiffStats{}
		withFKs     = _q.withFKs
		_spec       = _q.querySpec()
	...
	if withFKs {
		_spec.Node.Columns = append(_spec.Node.Columns, diffstats.ForeignKeys...)
	}
	_spec.ScanValues = func(columns []string) ([]any, error) {
		return (*DiffStats).scanValues(nil, columns)
	}
	_spec.Assign = func(columns []string, values []any) error {
		node := &DiffStats{config: _q.config}
	...
	if query := _q.withSession; query != nil {
		if err := _q.loadSession(ctx, query, nodes, nil,
			func(n *DiffStats, e *Session) { n.Edges.Session = e }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (_q *DiffStatsQuery) loadSession(ctx context.Context, query *SessionQuery, nodes []*DiffStats, init func(*DiffStats), assign func(*DiffStats, *Session)) error {
	ids := make([]int, 0, len(nodes))
	nodeids := make(map[int][]*DiffStats)
	for i := range nodes {
		if nodes[i].session_diff_stats == nil {
			continue
		}
		fk := *nodes[i].session_diff_stats
	...
	for _, n := range neighbors {
		...
		if !ok {
			return fmt.Errorf(`unexpected foreign-key "session_diff_stats" returned %v`, n.ID)
		}
		for i := range nodes {
			assign(nodes[i], n)
		}
...
func (_q *DiffStatsQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := _q.querySpec()
...
func (_q *DiffStatsQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(diffstats.Table, diffstats.Columns, sqlgraph.NewFieldSpec(diffstats.FieldID, field.TypeInt))
	_spec.From = _q.sql
...
func (_q *DiffStatsQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(_q.driver.Dialect())
	t1 := builder.Table(diffstats.Table)
	columns := _q.ctx.Fields
	if len(columns) == 0 {
		columns = diffstats.Columns
	}
...
func (_g *DiffStatsGroupBy) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*DiffStatsQuery, *DiffStatsGroupBy](ctx, _g.build, _g, _g.build.inters, v)
}

func (_g *DiffStatsGroupBy) sqlScan(ctx context.Context, root *DiffStatsQuery, v any) error {
...
func (_s *DiffStatsSelect) Scan(ctx context.Context, v any) error {
	...
	return scanWithInterceptors[*DiffStatsQuery, *DiffStatsSelect](ctx, _s.DiffStatsQuery, _s, _s.inters, v)
}

func (_s *DiffStatsSelect) sqlScan(ctx context.Context, root *DiffStatsQuery, v any) error {
