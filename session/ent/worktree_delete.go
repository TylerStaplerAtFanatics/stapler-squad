...
func (_d *WorktreeDelete) sqlExec(ctx context.Context) (int, error) {
	_spec := sqlgraph.NewDeleteSpec(worktree.Table, sqlgraph.NewFieldSpec(worktree.FieldID, field.TypeInt))
...
func (_d *WorktreeDeleteOne) Exec(ctx context.Context) error {
	...
	case err != nil:
		return err
	case n == 0:
		return &NotFoundError{worktree.Label}
	default:
		return nil
	}
}
