...
func InstanceToProto(inst *session.Instance, workflowNames map[string]string) *sessionv1.Session {
	...
	protoSession := &sessionv1.Session{
		...
		AutonomousTurn:     snap.AutonomousTurn,
		AutonomousMaxTurns: snap.AutonomousMaxTurns,
		AutonomousOutcome:  snap.AutonomousOutcome,
		Prompt:             snap.Prompt,
		...
		GithubPrNumber:  int32(snap.GitHubPRNumber),
		GithubPrUrl:     snap.GitHubPRURL,
		GithubOwner:     snap.GitHubOwner,
		GithubRepo:      snap.GitHubRepo,
		GithubSourceRef: snap.GitHubSourceRef,
		ClonedRepoPath:  snap.ClonedRepoPath,
		...
		GithubPrState:         snap.GitHubPRState,
		GithubPrIsDraft:       snap.GitHubPRIsDraft,
		GithubPrPriority:      snap.GitHubPRPriority,
		GithubApprovedCount:   int32(snap.GitHubApprovedCount),
		GithubChangesReqCount: int32(snap.GitHubChangesReqCount),
		GithubCheckConclusion: snap.GitHubCheckConclusion,
		LastPrStatusCheck:     timestamppb.New(snap.LastPRStatusCheck),
